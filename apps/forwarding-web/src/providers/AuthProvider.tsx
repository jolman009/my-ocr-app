...
// Same storage keys as Receipt Radar web — both products share the JWT, so a
// token issued by one verifies on the other.
...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <AuthContext.Provider
      value={{ isAuthenticated: !!token, isHydrating, login, logout, token, user }}
    >
      {children}
    </AuthContext.Provider>
  );
